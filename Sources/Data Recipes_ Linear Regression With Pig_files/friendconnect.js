...
var friendconnect_serverVersion = "0.1-b3c8717c_85ae2b43_4becb4dc_48c44a39_21ef397c.7";
...
fc.scale=function(a,b){var c="number"==typeof b?b:a;this.width*=a;this.height*=c;return this};var fcPa=!fcA||9<=fcEa;!fcB&&!fcA||fcA&&9<=fcEa||fcB&&fcD("1.9.1");fcA&&fcD("9");var fcM=function(a,b){return fcf(b)?a.getElementById(b):b},fcQa=function(a,b,c,d){a=d||a;var e=b&&"*"!=b?b.toUpperCase():"";if(a.querySelectorAll&&a.querySelector&&(e||c))return c=e+(c?"."+c:""),a.querySelectorAll(c);if(c&&a.getElementsByClassName){b=a.getElementsByClassName(c);if(e){a={};for(var f=d=0,k;k=b[f];f++)e==k.nodeName&&(a[d++]=k);a.length=d;return a}return b}b=a.getElementsByTagName(e||"*");if(c){a={};for(f=d=0;k=b[f];f++){var e=k.className,l;if(l="function"==typeof e.split)e=e.split(/\s+/),
l=0<=fcw(e,c);l&&(a[d++]=k)}a.length=d;return a}return b},fcSa=function(a,b){fcpa(b,function(b,d){"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:fcRa.hasOwnProperty(d)?a.setAttribute(fcRa[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,b):a[d]=b})},fcRa={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",
valign:"vAlign",width:"width"},fcTa=function(a){a=a.document;a="CSS1Compat"==a.compatMode?a.documentElement:a.body;return new fcL(a.clientWidth,a.clientHeight)},fcN=function(a,b,c){var d;d=arguments;var e=d[0],f=d[1];if(!fcPa&&f&&(f.name||f.type)){e=["<",e];f.name&&e.push(' name="',fcga(f.name),'"');if(f.type){e.push(' type="',fcga(f.type),'"');var k={};fcx(k,f);delete k.type;f=k}e.push(">");e=e.join("")}e=document.createElement(e);f&&(fcf(f)?e.className=f:"array"==fcd(f)?e.className=f.join(" "):
fcSa(e,f));2<d.length&&fcUa(document,e,d,2);return d=e},fcUa=function(a,b,c,d){function e(c){c&&b.appendChild(fcf(c)?a.createTextNode(c):c)}for(;d<c.length;d++){var f=c[d];if(!fce(f)||fcg(f)&&0<f.nodeType)e(f);else{var k;a:{if(f&&"number"==typeof f.length){if(fcg(f)){k="function"==typeof f.item||"string"==typeof f.item;break a}if("function"==fcd(f)){k="function"==typeof f.item;break a}}k=!1}fcma(k?fcna(f):f,e)}}};var fcVa="StopIteration"in fca?fca.StopIteration:{message:"StopIteration",stack:""},fcO=function(){};fcO.prototype.next=function(){throw fcVa;};fcO.prototype.__iterator__=function(){return this};var fcP=function(a,b){this.map_={};this.keys_=[];this.version_=this.count_=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else a&&this.addAll(a)};fc=fcP.prototype;fc.getCount=function(){return this.count_};fc.getValues=function(){this.cleanupKeysArray_();for(var a=[],b=0;b<this.keys_.length;b++){var c=this.keys_[b];a.push(this.map_[c])}return a};fc.getKeys=function(){this.cleanupKeysArray_();return this.keys_.concat()};
...
fc.__iterator__=function(a){this.cleanupKeysArray_();var b=0,c=this.version_,d=this,e=new fcO;e.next=function(){if(c!=d.version_)throw Error("The map has changed since the iterator was created");if(b>=d.keys_.length)throw fcVa;var e=d.keys_[b++];return a?e:d.map_[e]};return e};var fcQ=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};var fcR=function(a,b,c){if(fcf(b)){var d=c;(b=fcWa(a,b))&&(a.style[b]=d)}else for(d in b){c=a;var e=b[d],f=fcWa(c,d);f&&(c.style[f]=e)}},fcXa={},fcWa=function(a,b){var c=fcXa[b];if(!c){var d=fcha(b),c=d;void 0===a.style[d]&&(d=(fcC?"Webkit":fcB?"Moz":fcA?"ms":fcua?"O":null)+fcia(d),void 0!==a.style[d]&&(c=d));fcXa[b]=c}return c},fcYa=function(a,b){var c;c=a;fcv(c,"Node cannot be null or undefined.");c=9==c.nodeType?c:c.ownerDocument||c.document;return c.defaultView&&c.defaultView.getComputedStyle&&
(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""},fcS=function(a,b,c){if(b instanceof fcL)c=b.height,b=b.width;else if(void 0==c)throw Error("missing height argument");a.style.width=fcZa(b,!0);a.style.height=fcZa(c,!0)},fcZa=function(a,b){"number"==typeof a&&(a=(b?Math.round(a):a)+"px");return a},fc_a=function(a,b){var c;c=b;var d="display";c=fcYa(c,d)||(c.currentStyle?c.currentStyle[d]:null)||c.style&&c.style[d];if("none"!=c)return a(b);c=b.style;var d=c.display,e=c.visibility,
f=c.position;c.visibility="hidden";c.position="absolute";c.display="inline";var k=a(b);c.display=d;c.position=f;c.visibility=e;return k},fc0a=function(a){var b=a.offsetWidth,c=a.offsetHeight,d=fcC&&!b&&!c;if((!fcb(b)||d)&&a.getBoundingClientRect){var e;a:{try{e=a.getBoundingClientRect()}catch(f){e={left:0,top:0,right:0,bottom:0};break a}fcA&&a.ownerDocument.body&&(a=a.ownerDocument,e.left-=a.documentElement.clientLeft+a.body.clientLeft,e.top-=a.documentElement.clientTop+a.body.clientTop)}return new fcL(e.right-
e.left,e.bottom-e.top)}return new fcL(b,c)};var fc1a={},fc2a={};var fcT=function(a,b,c,d){b=b||"800";c=c||"550";d=d||"friendconnect";a=window.open(a,d,"menubar=no,toolbar=no,dialog=yes,location=yes,alwaysRaised=yes,width="+b+",height="+c+",resizable=yes,scrollbars=1,status=1");window.focus&&a&&a.focus()},fc3a=function(a,b){var c=gadgets.util.getUrlParameters().communityId;gadgets.rpc.call(null,"signin",null,c,a,b)};fcc("goog.peoplesense.util.openPopup",fcT,void 0);fcc("goog.peoplesense.util.finishSignIn",fc3a,void 0);var fc5a=function(a,b){var c=fcU()+"/friendconnect/invite/friends",d=encodeURIComponent(shindig.auth.getSecurityToken());fc4a(c,d,a,b)},fc4a=function(a,b,c,d){a+="?st="+b;c&&(a+="&customMessage="+encodeURIComponent(c));d&&(a+="&customInviteUrl="+encodeURIComponent(d));b=760;fcA&&(b+=25);fcT(a,String(b),"515","friendconnect_invite")};fcc("goog.peoplesense.util.invite",fc5a,void 0);fcc("goog.peoplesense.util.inviteFriends",fc4a,void 0);var fcV=function(a){this.url=a};fcV.prototype.addParam=function(a,b){if(0<=this.url.indexOf("?"+a+"=")||0<=this.url.indexOf("&"+a+"="))throw Error("duplicate: "+a);if(null===b||void 0===b)return this;var c=0<=this.url.indexOf("?")?"&":"?";this.url+=c+a+"="+encodeURIComponent(String(b));return this};fcV.prototype.toString=function(){return this.url};var fcU=function(){return window.friendconnect_serverBase},fcW=function(a,b){var c=gadgets.util.getUrlParameters().psinvite||"",d=new fcV(fcU()+"/friendconnect/signin/home");d.addParam("st",window.shindig.auth.getSecurityToken());d.addParam("psinvite",c);d.addParam("iframeId",a);d.addParam("loginProvider",b);d.addParam("subscribeOnSignin","1");fcT(d.toString());return!1},fc6a=function(){var a=gadgets.util.getUrlParameters().communityId;gadgets.rpc.call(null,"signout",null,a)},fc8a=function(a,b){var c=
fcU()+"/friendconnect/settings/edit?st="+encodeURIComponent(shindig.auth.getSecurityToken())+(a?"&iframeId="+encodeURIComponent(a):"");b&&(c=c+"&"+b);fc7a(c)},fc9a=function(a){a=fcU()+"/friendconnect/settings/siteProfile?st="+encodeURIComponent(a);fc7a(a)},fc7a=function(a){var b=800;fcA&&(b+=25);fcT(a,String(b),"510")},fc$a=function(a,b){var c=b=b||fci(fcW,null,null,null,null);if(!a)throw"google.friendconnect.renderSignInButton: missing options";var d=a.style||"standard",e=a.text,f=a.version;if("standard"==
...
fcN("tbody",{"class":""},fcN("tr",{"class":""},fcN("td",{"class":"gfc-button-base-v2 gfc-button-1"}),fcN("td",{"class":"gfc-button-base-v2 gfc-button-2"},e),fcN("td",{"class":"gfc-button-base-v2 gfc-button-3"})))),k.appendChild(l),"standard"==d&&(e=fcN("div",{"class":"gfc-footer-msg"},"with Google Friend Connect"),1==f&&k.appendChild(fcN("br")),k.appendChild(e));k=l;window.addEventListener?k.addEventListener("click",c,!1):k.attachEvent("onclick",c)},fcab=function(a,b){gadgets.rpc.call(null,"putReloadViewParam",
null,a,b);var c=gadgets.views.getParams();c[a]=b},fcbb=function(a,b){var c=new fcV("/friendconnect/gadgetshare/friends");c.addParam("customMessage",a);c.addParam("customInviteUrl",b);c.addParam("container","glb");var d=310;fcA&&(d+=25);var d=String(d),e="370",f=void 0,k=void 0,d=d||"800",e=e||"550",f=f||"friendconnect",k=k||!1;gadgets.rpc.call(null,"openLightboxIframe",void 0,c.toString(),shindig.auth.getSecurityToken(),d,e,f,void 0,null,null,null,k)};fcc("goog.peoplesense.util.getBaseUrl",fcU,void 0);
fcc("goog.peoplesense.util.finishSignIn",fc3a,void 0);fcc("goog.peoplesense.util.signout",fc6a,void 0);fcc("goog.peoplesense.util.signin",fcW,void 0);fcc("goog.peoplesense.util.editSettings",fc8a,void 0);fcc("goog.peoplesense.util.editSSProfile",fc9a,void 0);fcc("goog.peoplesense.util.setStickyViewParamToken",fcab,void 0);fcc("google.friendconnect.renderSignInButton",fc$a,void 0);fcc("goog.peoplesense.util.share",fcbb,void 0);fcc("goog.peoplesense.util.userAgent.IE",fcA,void 0);var fccb={},fcX=function(a){this.menus_=new fcP;this.snippetId=a.id;this.site=a.site;a=a["view-params"];var b=a.skin;this.position_=(b?b.POSITION:"top")||"top";this.childView_={allowAnonymousPost:a.allowAnonymousPost||!1,scope:a.scope||"SITE",docId:a.docId||"",features:a.features||"video,comment",startMaximized:"true",disableMinMax:"true",skin:b};this.absoluteBottom=fcA&&!fcD("7");this.fixedIeSizes=fcA;window.addEventListener?window.addEventListener("resize",fci(this.resize_,this),!1):window.attachEvent("onresize",
...
fc.getBodyWidth_=function(){var a=fcM(document,this.barId_);return a=fc_a(fc0a,a).width};fc.resize_=function(){for(var a=this.menus_.getKeys(),b=0;b<a.length;b++)this.resizeMenu(a[b]);goog&&fc1a&&fc2a&&fcY&&fcdb("resize")};fc.getPosition=function(){return this.position_};fc.getShadowClass=function(a){return this.barPrefix_+"shadow-"+a};fc.getMenuId=function(a){return this.barPrefix_+"menus-"+a};fc.getTargetId=function(a){return this.barPrefix_+a+"Target"};
...
fc.showMenu=function(a,b){var c=this.menus_.get(a);if(c){c.drawer||(c.drawer=fcM(document,this.getDrawerId(c.name)),c.target=fcM(document,this.getTargetId(c.name)),c.sha_bc=fcQa(document,"div","top"==this.getPosition()?this.getShadowClass("bc"):this.getShadowClass("tc"),c.drawer)[0],c.sha_cr=fcQa(document,"div",this.getShadowClass("cr"),c.drawer)[0]);for(var d=this.menus_.getKeys(),e=0;e<d.length;e++){var f=d[e];a!==f&&this.hideMenu(f)}c.evaluateConstraints(b);c.drawer.style.display="";window.setTimeout(function(){c.applySkin();
c.fixShadowsForIe_();c.render()},0)}};var fceb=function(a,b,c,d,e){this.id=-1;this.bar=a;this.name=b;this.constraints=d;this.skin=e||{};this.height=this.skin.HEIGHT||"0";this.url=window.friendconnect_serverBase+c;this.sha_bc=this.target=this.drawer=null;this.loaded=this.rendered=!1;this.evaluateConstraints()};fc=fceb.prototype;
...
fc.fixShadowsForIe_=function(){if(fcA&&this.drawer){var a=fc_a(fc0a,this.target),b=a.width-this.bar.shadowWidth_,a=a.height;0>b&&(b=0);this.sha_bc&&this.sha_bc.style&&fcS(this.sha_bc,b,"");this.sha_cr&&this.sha_cr.style&&fcS(this.sha_cr,"",a)}};
...
var fcjb=function(){var a="1"==gadgets.util.getUrlParameters().canvas||"1"==gadgets.util.getUrlParameters().embed,b=null;a&&(b=gadgets.util.getUrlParameters().caller);b||(a=document.location,b=a.search.replace(/([&?]?)psinvite=[^&]*(&?)/,function(a,b,e){return e?b:""}),b=a.protocol+"//"+a.hostname+(a.port?":"+a.port:"")+a.pathname+b);return b};fc=fc6.prototype;fc.setView=function(a){this.view_=a};fc.getView=function(){return this.view_};fc.getBodyId=function(){return this.getIframeId()+"_body"};
...
fc.getCanvasUrl=function(){var a=fcjb(),a="canvas=1&caller="+encodeURIComponent(a),b=gadgets.util.getUrlParameters().psinvite;b&&(a+="&psinvite="+encodeURIComponent(b));a+="&site="+encodeURIComponent(this.communityId);b=fch(this.viewParams);if(null!=b.skin)for(var c="BG_IMAGE BG_COLOR FONT_COLOR BG_POSITION BG_REPEAT ANCHOR_COLOR FONT_FACE BORDER_COLOR CONTENT_BG_COLOR CONTENT_HEADLINE_COLOR CONTENT_LINK_COLOR CONTENT_SECONDARY_TEXT_COLOR CONTENT_SECONDARY_LINK_COLOR CONTENT_TEXT_COLOR ENDCAP_BG_COLOR ENDCAP_LINK_COLOR ENDCAP_TEXT_COLOR CONTENT_VISITED_LINK_COLOR ALTERNATE_BG_COLOR".split(" "),
...
fc.getUrlForView=function(a){var b=null;if("canvas"==a)b=this.getCanvasUrl();else if("profile"==a)b=this.getProfileUrl();else return null;a=b;a instanceof fcK||(a=a.implementsGoogStringTypedString?a.getTypedStringValue():String(a),fcOa.test(a)||(a="about:invalid#zClosurez"),b=new fcK,b.privateDoNotAccessOrElseSafeHtmlWrappedValue_=a,a=b);a instanceof fcK&&a.constructor===fcK&&a.SAFE_URL_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_===fcNa?a=a.privateDoNotAccessOrElseSafeHtmlWrappedValue_:(fcla("expected object of type SafeUrl, got '"+
...
fc.showLightBoxDialog=function(a,b,c,d,e,f){this.containerCssIsLoaded_||(this.addCssFile_(window.friendconnect_serverBase+"/friendconnect/styles/container.css?d="+this.serverVersion_),this.containerCssIsLoaded_=!0);var k=fclb(d);this.lightboxCssIsLoaded_!=(k?"rtl":"ltr")&&(this.addCssFile_(window.friendconnect_serverBase+"/friendconnect/styles/lightbox"+(k?"-rtl":"")+".css?d="+this.serverVersion_),this.lightboxCssIsLoaded_=k?"rtl":"ltr");this.lightBoxJsIsLoaded_||(this.addJsFile_(window.friendconnect_serverBase+
...
c};
fc8.prototype.showLightboxGadget_=function(a,b){a=a||{};var c=a.locale,d=fclb(c),e=this;this.closeLastLightBoxDialog();this.showLightBoxDialog(function(b){var c=fcN("div",{},fcN("div",{id:"gadget-signin",style:"background-color:#ffffff;height:32px;"}),fcN("div",{id:"gadget-lb-canvas",style:"background-color:#ffffff;"}));b.getTitleTextElement().appendChild(fcN("div",{id:"gfc-canvas-title",style:"color:#000000;"}));b.getContentElement().appendChild(c);b.setVisible(!0);var c=fch(a),l=fcTa(window),m=
...
"&":"?")+f+"&communityId="+u;fckb(r,a,"POST",p,null,null,null)},void 0,g,void 0,c,d)};fc0.prototype.deliverViewParams=function(){var a=fc$(this.f),a=fcZ.getGadget(a);return a.viewParams};fc0.prototype.deliverContainerBaseTime=function(){return fcfb};fc0.prototype.putReloadViewParam=function(a,b){var c=fc$(this.f),c=fcZ.getGadget(c);c.viewParams[a]=b};fc8.prototype.handleGadgetLoad=function(a,b){null!=fcZ.friendbar_&&fcZ.friendbar_.menuLoad(b)};
...
fc0.prototype.setTitle=function(a){var b=fc$(this.f),b=fcZ.getGadget(b);if(b=b.titleDivId)document.getElementById(b).innerHTML=gadgets.util.escapeString(a)};fc0.prototype.signin=function(a,b,c){fcJ.set(fcZ.getAuthCookieName(a),b,31104E3,c);fcJ.set(fcZ.getSessionAuthCookieName(a),b,-1,c);fcZ.currentAuthToken_[a]=b;fcZ.refreshGadgets()};var fcnb=function(a){fc$a(a,fcmb)};fc=fc8.prototype;
...
var fcob=function(a){var b;if(a.multiple){b=[];for(var c=0;c<a.options.length;c++)a.options[c].selected&&b.push(a.options[c].value);c=a.getAttribute("x-max");try{c*=1}catch(e){c=0}if(c&&b.length>c&&a["x-selected"])for(b=a["x-selected"],c=0;c<a.options.length;c++){a.options[c].selected=!1;for(var d=0;d<b.length;d++)if(a.options[c].value==b[d]){a.options[c].selected=!0;break}}}else b=a.options[a.selectedIndex].value;a["x-selected"]=b;(c=a.getAttribute("x-var"))&&window.opensocial.data&&window.opensocial.data.getDataContext().putDataSet(c,
...
fc8.prototype.getGadgetCommunityId=function(a){var b=null;(a=this.getGadgetByDivId(a))&&a.communityId&&(b=a.communityId);return b};var fcmb=function(a){fcZ.openSocialApiIframeId&&fcW(fcZ.openSocialApiIframeId,a)},fcqb=function(){fc0.prototype.signout(fcZ.openSocialSiteId)},fcrb=function(){fc8a(fcZ.openSocialApiIframeId)},fcsb=function(a,b){fc5a(a,b)},fcY=function(){this.subscribers_={}};
...
fcc("google.friendconnect.container.getGadgetSecurityToken",fcZ.getGadgetSecurityToken,void 0);fcc("google.friendconnect.container.getGadgetCommunityId",fcZ.getGadgetCommunityId,void 0);fcc("google.friendconnect.container.showEmbedDialog",fcZ.showEmbedDialog,void 0);fcc("google.friendconnect.container.showMemberProfile",fcZ.showMemberProfile,void 0);fcc("google.friendconnect.requestSignIn",fcmb,void 0);fcc("google.friendconnect.requestSignOut",fcqb,void 0);
fcc("google.friendconnect.requestSettings",fcrb,void 0);fcc("google.friendconnect.requestInvite",fcsb,void 0);fcc("google.friendconnect.renderSignInButton",fcnb,void 0);fcc("google.friendconnect.container.invokeOpenSocialApiViaIframe",fcZ.invokeOpenSocialApiViaIframe,void 0);fcc("google.friendconnect.container.removeOpenSocialApiViaIframe",fcZ.removeOpenSocialApiViaIframe,void 0);fcc("google.friendconnect.userAgent.WEBKIT",fcC,void 0);fcc("google.friendconnect.userAgent.IE",fcA,void 0);
fcc("google.friendconnect.PeopleSelectorOnChange",fcob,void 0);fcc("google.friendconnect.container.setDateStamp_",fcZ.setDateStamp_,void 0);
google.friendconnect.container.setServerBase('http://www-a-fc-opensocial.googleusercontent.com/ps/');google.friendconnect.container.setServerVersion('0.1-b3c8717c_85ae2b43_4becb4dc_48c44a39_21ef397c.7');google.friendconnect.container.setApiVersion('0.8');
...
google.friendconnect.container.setDateStamp_('152080578d7');